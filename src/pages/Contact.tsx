const Contact = () => {
  return (
    <div className="container mx-auto px-6 py-16 max-w-4xl">
      {/* Header */}
      <div className="text-center border-b-2 border-primary pb-6 mb-12">
        <h1 className="text-4xl font-bold text-foreground mb-4">Let's Connect</h1>
      ...
      <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                ...
                className="flex items-center bg-muted/30 border border-border rounded-lg p-4 hover:border-primary transition-colors group"
              >
                <svg className="w-5 h-5 mr-3 text-primary" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                </svg>
                <span className="font-medium text-foreground group-hover:text-primary transition-colors">LinkedIn Profile</span>
              </a>
              ...
              >
                ...
                <span className="font-medium text-foreground group-hover:text-primary transition-colors">GitHub Projects</span>
              </a>
              ...
              >
                ...
                <span className="font-medium text-foreground group-hover:text-primary transition-colors">REACTU.io</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            <div className="bg-muted/30 border border-border rounded-lg p-5">
              <h3 className="text-lg font-semibold text-foreground mb-3">Multisensory AI & Healthcare</h3>
            ...
            <div className="bg-muted/30 border border-border rounded-lg p-5">
              <h3 className="text-lg font-semibold text-foreground mb-3">Responsive Environments</h3>
              <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
            ...
            <div className="bg-muted/30 border border-border rounded-lg p-5">
              <h3 className="text-lg font-semibold text-foreground mb-3">Social Robotics & Assistive Technology</h3>
              <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
